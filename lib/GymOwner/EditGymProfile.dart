...
class EditGymProfile extends StatefulWidget {
  @override
  State<EditGymProfile> createState() => _EditGymProfileState();
}

class _EditGymProfileState extends State<EditGymProfile> {
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            icon: Icon(Icons.save, color: Colors.lightBlue[900]),
            onPressed: () {
              gymOwnerReference
                  .doc(gSignIn.currentUser?.id)
                  .collection("FitnessCenterDetails")
                  .doc(gSignIn.currentUser?.id)
                  .update({'name': OwnernameController.text});
              showSnackBar();
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              gymOwnerReference
                  ...
                  .collection("FitnessCenterDetails")
                  .doc(gSignIn.currentUser?.id)
                  .update({'centername': CenternameController.text});
              showSnackBar();
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              gymOwnerReference
                  ...
                  .collection("FitnessCenterDetails")
                  .doc(gSignIn.currentUser?.id)
                  .update({'opentime': timeinputopen.text});
              showSnackBar();
              timeinputopen.clear();
            },
          ),
        ...
        suffixIcon: IconButton(
          ...
          onPressed: () {
            gymOwnerReference
                ...
                .collection("FitnessCenterDetails")
                .doc(gSignIn.currentUser?.id)
                .update({'name': timeinputclose.text});
            showSnackBar();
            timeinputclose.clear();
          },
        ),
        prefixIcon: Icon(
          Icons.lock,
          ...
          inputDecoration: InputDecoration(
            suffixIcon: IconButton(
              ...
              onPressed: () async {
                ...
                DocumentSnapshot doc = await gymOwnerReference
                    .doc(gSignIn.currentUser?.id)
                    .collection("FitnessCenterDetails")
                    .doc(gSignIn.currentUser?.id)
                    .get();
                List equipList = doc['equipment'];
                List mergeList = new List.from(EquipmentsNames)
                  ..addAll(equipList);
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              gymOwnerReference
                  ...
                  .collection("FitnessCenterDetails")
                  .doc(gSignIn.currentUser?.id)
                  .update({'MonthFee': MonthlyController.text});
              showSnackBar();
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () {
                  gymOwnerReference
                      ...
                      .collection("FitnessCenterDetails")
                      .doc(gSignIn.currentUser?.id)
                      .update({'Lat': LatitudeController.text});
                  showSnackBar();
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () {
                  gymOwnerReference
                      ...
                      .collection("FitnessCenterDetails")
                      .doc(gSignIn.currentUser?.id)
                      .update({'Lng': LongitudeController.text});
                  showSnackBar();
...
// Gender Type
        ...
        TextButton(
          onPressed: () {
            gymOwnerReference
                ...
                .collection("FitnessCenterDetails")
                .doc(gSignIn.currentUser?.id)
                .update({'Gender': _myActivityGender});
            showSnackBar();
          },
          child: Text("Update"),
        )
  ...
  AddImages() async {
    ...
    DocumentSnapshot doc = await gymOwnerReference
        ...
        .doc(gSignIn.currentUser?.id)
        .get();
    List ImgList = doc['Images'];
    List mergeList = new List.from(ImageUrls)..addAll(ImgList);

    gymOwnerReference
        .doc(gSignIn.currentUser?.id)
        .collection("FitnessCenterDetails")
        .doc(gSignIn.currentUser?.id)
        .update({'Images': mergeList});
    setState(() {
      imagefiles = [];
    });
  }
